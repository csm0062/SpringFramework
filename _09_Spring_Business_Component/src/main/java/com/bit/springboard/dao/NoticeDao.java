...
public class NoticeDao {
    ...
    public List<BoardDto> getBoardList() {
        System.out.println("Notice의 getBoardList 메소드 실행");
        ...
        System.out.println("Notice의 getBoardList 메소드 실행 종료");
        return boardDtoList;
    }

    // DELETE
    public void delete(int id) {
        System.out.println("Notice의 delete메소드 실행");
        ...
        System.out.println("Notice의 delete메소드 실행 종료");
    }

    public BoardDto getBoard(int id) {
        System.out.println("Notice의 getBoard메소드 실행");
        ...
        System.out.println("Notice의 getBoard메소드 실행 종료");
            return boardDto;
