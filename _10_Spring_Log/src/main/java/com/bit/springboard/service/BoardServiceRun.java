...
public class BoardServiceRun {
    public static void main(String[] args) {
        AbstractApplicationContext factory =
                new GenericXmlApplicationContext("root-context.xml");

        BoardService boardService = (BoardService) factory.getBean("freeBoardServiceImpl", BoardService.class);
        ...
        // 특정 id의 계시글 하나만 조회
        System.out.println(boardService.getBoard(6));
